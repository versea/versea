...
// type VerseaEventListener = EventListenerOrEventListenerObject & {
//   // eslint-disable-next-line @typescript-eslint/naming-convention
//   __VERSEA_APP_MARK_OPTIONS__: Record<string, unknown>;
// };
...
//   microAppWindow.setInterval = function (handler: TimerHandler, timeout?: number, ...args: any[]): number {
//     const intervalId = rawSetInterval.call(rawWindow, handler, timeout, ...args);
//     intervalIdMap.set(intervalId, { handler, timeout, args });
//     return intervalId;
//   };

//   microAppWindow.setTimeout = function (handler: TimerHandler, timeout?: number, ...args: any[]): number {
